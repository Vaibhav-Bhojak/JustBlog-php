  ...
  <body>
    ...
    >
      ...
      >
        <div class="flex items-center justify-between">
          <h1 class="text-blue-500 text-xl font-bold">Just Blog</h1>
        </div>
            ...
            <div class="items-center lg:flex">
                <div class="w-full lg:w-1/2">
                    <div class="lg:max-w-lg">
                        <h1 class="text-3xl font-semibold text-gray-800 dark:text-white lg:text-4xl"> Write your story, share your Blog, and let the world listen! <br> <span class="text-blue-500 ">Best place to write blog</span></h1>
                        
                        <p class="mt-3 text-gray-600 dark:text-gray-400">Unleash your creativity and share your thoughts with the world! Our blogging platform empowers you to write, inspire, and connect with a global audience. Start your journey today!</p>
                        
                        <a href="signup.php"><button class="w-full px-5 py-2 mt-6 text-sm tracking-wider text-white uppercase transition-colors duration-300 transform bg-blue-600 rounded-lg lg:w-auto hover:bg-blue-500 focus:outline-none focus:bg-blue-500">Create Blog</button></a>
                        <a href="allposts.php"><button class="w-full px-5 py-2 mt-6 text-sm tracking-wider text-white uppercase transition-colors duration-300 transform bg-blue-600 rounded-lg lg:w-auto hover:bg-blue-500 focus:outline-none focus:bg-blue-500">Blogs</button></a>
                    </div>
                </div>
    
                <div class="flex items-center justify-center w-full mt-6 lg:mt-0 lg:w-1/2">
                    <img class="w-full h-full lg:max-w-3xl" src="img/head1.png" alt="Catalogue-pana.svg">
                </div>
            </div>
        </div>
    </header>
    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="container px-6 py-10 mx-auto">
            <h1 class="text-2xl font-semibold text-gray-800 capitalize lg:text-3xl dark:text-white">Explore our <br> Features</h1>
    
            <p class="mt-4 text-gray-500 xl:mt-6 dark:text-gray-300">
                Write, publish, and grow—effortlessly! 🚀 Enjoy a sleek editor, SEO tools, customizable themes, and seamless social sharing. Your voice, your blog, your way!
            </p>
            ...
            <div class="grid grid-cols-1 gap-8 mt-8 xl:mt-12 xl:gap-12 md:grid-cols-2 xl:grid-cols-3">
                <div class="p-8 space-y-3 border-2 border-blue-400 dark:border-blue-300 rounded-xl">
                    ...
                    <p class="text-gray-500 dark:text-gray-300">
                        Blog in style with our sleek Dark Mode! 🌙 Experience a stunning, eye-friendly interface that enhances focus and adds a touch of elegance to your writing.
                    </p>
                ...
                <div class="p-8 space-y-3 border-2 border-blue-400 dark:border-blue-300 rounded-xl">
                    ...
                    <p class="text-gray-500 dark:text-gray-300">
                        Make your blog truly yours! 🎨 With easy customization, you can tweak layouts, colors, and fonts effortlessly—no coding needed. Create, style, and shine!
                    </p>
                ...
                <div class="p-8 space-y-3 border-2 border-blue-400 dark:border-blue-300 rounded-xl">
                    ...
                    <p class="text-gray-500 dark:text-gray-300">
                        Less clutter, more impact! ✨ Our simple and clean design ensures a seamless, distraction-free blogging experience—where your words take center stage.
                    </p>
    ...
    <section class="bg-white dark:bg-gray-900" id="team">
        <div class="container px-6 py-10 mx-auto">
            <h1 class="text-2xl font-semibold text-center text-gray-800 capitalize lg:text-3xl dark:text-white">Our <span class="text-blue-500">Executive Developer</span></h1>
    
            <p class="max-w-2xl mx-auto my-6 text-center text-gray-500 dark:text-gray-300">
                Powered by passion, driven by expertise! 🚀 Our experienced team is here to help you create, grow, and shine in the blogging world.
            </p>
                ...
                <div class="px-12 py-8 transition-colors duration-300 transform border cursor-pointer rounded-xl hover:border-transparent group hover:bg-blue-600 dark:border-gray-700 dark:hover:border-transparent">
                    <div class="flex flex-col sm:-mx-4 sm:flex-row">
                        <img class="flex-shrink-0 object-cover w-24 h-24 rounded-full sm:mx-4 ring-4 ring-gray-300" src="img/profile.jpg" alt="">
    
                        <div class="mt-4 sm:mx-4 sm:mt-0">
                            <h1 class="text-xl font-semibold text-gray-700 capitalize md:text-2xl dark:text-white group-hover:text-white">Vaibhav Bhojak</h1>
    
                            <p class="mt-2 text-gray-500 capitalize dark:text-gray-300 group-hover:text-gray-300">Full Stack Developer</p>
                        </div>
                    </div>
    
                    <p class="mt-4 text-gray-500 capitalize dark:text-gray-300 group-hover:text-gray-300">Building seamless digital experiences from front to back! 💻⚡ As a Full Stack Developer, I craft dynamic, high-performance web applications with cutting-edge technologies.</p>
